...
function start_prediction() {
    ...
    $.get(url, function(csvData) {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://srv.ibc.bio:32855/predict',
...
function poll(task_id){
    console.log("poll")
    $.getJSON('http://srv.ibc.bio:32855/tasks/<task_id>?task_id=' + task_id, function(data) {
    //$.getJSON('http://localhost:8000/tasks/<task_id>?task_id=' + task_id, function(data) {
